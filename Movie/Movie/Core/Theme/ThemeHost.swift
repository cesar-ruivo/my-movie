...
class ThemeHost {
    ...
    func fetchRemoteTheme(completion: @escaping (AppTheme?) -> Void) {
        guard let url = URL(string: "https://gist.githubusercontent.com/cesar-ruivo/53fc060661d2cc3d6174f27e4d649e5a/raw/c48b31e1b089b4a37c5079f0d22273d021c76eeb/theme.json") else {
