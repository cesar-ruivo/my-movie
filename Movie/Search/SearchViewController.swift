...
class SearchViewController: UIViewController {
    ...
    //MARK: - componentes UI
    private lazy var searchHeader: SearchHeader = {
        let view = SearchHeader()
...
extension SearchViewController: CodeView {
    func setupContraints() {
        NSLayoutConstraint.activate([
            ...
            collectionView.topAnchor.constraint(equalTo: searchHeader.bottomAnchor, constant: 8),
...
extension SearchViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch sectionType {
        case .nowPlaying, .popular, .topRate, .search:
...
extension SearchViewController: SearchHeaderDelegateProtocol {
    func didChangeSearchText(text: String) {
        print("O usuario digitou: \(text)")
